...
class UsersController extends Controller {
    ...
    public function storeEmployee(Request $request)
    {
        ...
        return redirect()->route('users')->with('message', 'Employee account created successfully.');
    }
    ...
    public function giveGift(Request $request, User $user) {
        ...
        if ($user->addCredit($request->amount)) {
            return redirect()->route('users')->with('message', number_format($request->amount, 2) . ' credits have been added to ' . $user->name);
        }

        return redirect()->back()->withErrors('Failed to add credit. Please try again.');
    }
